...
export const PERMISSIONS = {
    ...
    // Aircraft Management
    AIRCRAFT_READ: 0x0002,
    AIRCRAFT_WRITE: 0x0001,
    AIRCRAFT_MANAGE: 0x400000,
    AIRCRAFT_DELETE: 0x800000,
    
    // Maintenance
    MAINTENANCE_SCHEDULE: 0x1000000,
    MAINTENANCE_RECORDS: 0x2000000,
...
export const ROLE_PERMISSIONS = {
    [AVIATION_ROLES.SUPER_ADMIN]: 
        ...
        PERMISSIONS.AIRCRAFT_READ |
        PERMISSIONS.AIRCRAFT_WRITE |
        PERMISSIONS.AIRCRAFT_MANAGE |
        PERMISSIONS.AIRCRAFT_DELETE |
